...
<div align="center">
  <table style="border-collapse: separate; border-spacing: 0; border-radius: 12px; overflow: hidden; border: 1px solid #2D9CDB;">
    <tr>
      <td align="center" style="background: linear-gradient(135deg, #0d1b2a, #1a2f4a); padding: 16px 24px; border-right: 1px solid #2D9CDB33;">
        <strong>🚀 2+ años</strong><br/>construyendo software real
      </td>
      <td align="center" style="background: linear-gradient(135deg, #0d1b2a, #1a2f4a); padding: 16px 24px; border-right: 1px solid #2D9CDB33;">
        <strong>📈 97%</strong><br/>eficiencia en algoritmo logístico de flota
      </td>
      <td align="center" style="background: linear-gradient(135deg, #0d1b2a, #1a2f4a); padding: 16px 24px;">
        <strong>🏢 Co-fundador técnico</strong><br/>NóminaApp SaaS
      </td>
    </tr>
  </table>
</div>
...
<div align="center">
  ...
  <a href="mailto:zepta2249@gmail.com" target="_blank">
    <img src="https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white" />
  </a>
  <a href="https://camilo-zapata-cv.vercel.app/" target="_blank">
...
### 💼 NóminaApp — SaaS de nómina para PYMEs colombianas
SaaS multi-tenant de nómina automatizada para contadores y PYMEs. Arquitectura multi-tenant con control de roles, gestión de trabajadores, contratos y generación automática de desprendibles de pago con lógica contable colombiana completa.
